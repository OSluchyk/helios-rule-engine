...
a|
This stage is designed to be ultra-fast and allocation-free in the hot path. The `DefaultRuleEvaluator` uses the pre-computed `EngineModel` to evaluate incoming events.
