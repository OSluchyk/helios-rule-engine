...
import com.helios.ruleengine.core.compiler.RuleCompiler;import com.helios.ruleengine.core.evaluation_old.RuleEvaluator;import com.helios.ruleengine.core.model.EngineModel;import com.helios.ruleengine.infrastructure.telemetry.TracingService;import com.helios.ruleengine.model.*;
...
*RuleCompiler* — compiles JSON rules into optimized `EngineModel`.
...
*EvaluationContext* — represents an event to evaluate.
