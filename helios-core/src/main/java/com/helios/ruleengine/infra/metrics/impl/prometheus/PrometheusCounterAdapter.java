 ...
 *
 * <p>
 * Thread-safe wrapper around Prometheus counter. Handles label binding
...
final class PrometheusCounterAdapter implements Counter {
     ...
     *
     * <p>
     * Thread-safe operation. Multiple threads can increment concurrently
     ...
     *
     * <p>
     * This is a read of the current value and may not reflect concurrent
